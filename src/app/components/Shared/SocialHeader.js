...
function SocialHeader() {
    return (
        <div className='px-16 py-1.5 bg-sky-100 flex items-center justify-between '>
            <div className='flex'>
                <span className='mx-1 text-xl'><CiFacebook /></span>
                <span className='mx-1 text-xl'><CiYoutube /></span>
                <span className='mx-1 text-xl'><CiTwitter /></span>
            </div>
            <div className='flex'>
            ...
            <div className='flex items-center'>
                <div className='flex items-center'>
                    <FaWhatsapp />
                    <span className='ml-1'>0162912959</span>
                </div>
                <div className='flex items-center ml-5'>
                    <MdOutlineMailOutline />
                    <span className='ml-1'>info@zaman.com</span>
                </div>
            </div>
        </div>
    )
